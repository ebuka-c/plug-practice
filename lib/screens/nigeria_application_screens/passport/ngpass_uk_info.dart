...
class NgPassUkInfo extends GetView<ApplicationController> {
  const NgPassUkInfo({super.key});
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          Text('UK Contact Information',
                              style: titleMid.copyWith(
                                  color: AppColors.textColor2))
                        ]),
                        SizedBox(height: 15.0.h),
                        ApplicationPhoneNumField(title: 'Contact'),
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              AppButton(
                                  onTap: () {
                                    Get.toNamed(AppRoutes.ngContactInfo);
                                  },
                                  text: 'Next',
                                  height: 23.0.w,
                                  width: 63.0.h,
