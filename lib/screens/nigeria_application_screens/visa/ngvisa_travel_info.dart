...
class NgVisaTravelInfo extends GetView<ApplicationController> {
  const NgVisaTravelInfo({super.key});
            ...
            Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const ApplicationTextField(
                          title:
                              'Have you applied for Nigeria visa in the last 3 years?'),
                      SizedBox(height: 13.0.h),
                      const ApplicationTextField(
                          title: 'If yes, where did you apply fot the visa?'),
                      SizedBox(height: 13.0.h),
                      const ApplicationTextField(
                          title: 'Was the visa granted or rejected?',
                          textCapitalization: TextCapitalization.words),
                      SizedBox(height: 13.0.h),
                      const ApplicationTextField(
                          title: 'If rejected, please provide reason',
                          textCapitalization: TextCapitalization.words),
                      SizedBox(height: 13.0.h),
                      const ApplicationTextField(
                          title:
                              'Have your fingerprints been captured previously?'),
                      SizedBox(height: 13.0.h),
                      const ApplicationTextField(
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            AppButton(
                                onTap: () {
                                  Get.toNamed(AppRoutes.ngVisaContactInNig);
                                },
                                text: 'Next',
                                height: 23.0.w,
                                width: 63.0.h,
