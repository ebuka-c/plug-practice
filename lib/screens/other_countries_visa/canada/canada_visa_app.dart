...
class CanadaVisaApp extends GetView<ApplicationController> {
  const CanadaVisaApp({super.key});
                          ...
                          children: [
                            ...
                            RadioSelectableInput(title: 'Gender', options: [
                              CustomRadioTile(
                                  ...
                                  onChanged: (val) {
                                    controller.schGenderValue.value =
                                        val as int;
                                  },
                                  title: 'Male'),
                              CustomRadioTile(
                            ...
                            Center(
                              ...
                              AppButton(
                                  onTap: () {
                                    Get.toNamed(AppRoutes.caReviewSubmit);
                                  },
                                  text: 'Next',
                                  height: 23.0.w,
                                  width: 63.0.h,
